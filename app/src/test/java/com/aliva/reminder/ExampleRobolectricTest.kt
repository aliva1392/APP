...
class ExampleRobolectricTest {
  ...
  fun testDatabaseMigrations() {
    ...
    com.aliva.reminder.data.ReminderDatabase.MIGRATION_1_2.migrate(db)
    ...
    com.aliva.reminder.data.ReminderDatabase.MIGRATION_2_3.migrate(db)
    ...
    com.aliva.reminder.data.ReminderDatabase.MIGRATION_3_4.migrate(db)
