package com.aliva.reminder.receiver
            ...
            CoroutineScope(Dispatchers.IO).launch {
                try {
                    ...
                    installments.filter { !it.isCompleted }.forEach { inst ->
                        NotificationReceiver.scheduleInstallmentAlarms(context, inst)
                    }

                    // Reschedule alarms for all uncleared cheques
                    cheques.filter { !it.isCleared }.forEach { ch ->
                        NotificationReceiver.scheduleChequeAlarms(context, ch)
                    }
                    ...
                    if (closestItem != null) {
                        ...
                        if (closestItem is com.aliva.reminder.data.Installment) {
                            ...
                            val ch = closestItem as com.aliva.reminder.data.Cheque
